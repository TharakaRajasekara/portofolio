  ...
  return (
    <Container id='project'>
        <Zoom>
            ...
            <p>The site features sections like Home, About, Classes, Schedules, and Contact, providing comprehensive information on various dance styles such as Salsa, Merengue, Cumbia, Hip-Hop, Belly Dance, and Cha-Cha-Cha. It includes motivational content, class schedules, and instructor details, aiming to inspire users to join the fitness studio and embrace an energetic and healthy lifestyle.</p>
        </Zoom>
        <Slide>
            <SliderComp/>
        </Slide>
